...
import { MidiController } from "../../../core/midi/midi_controller_service";
...
export class Piano extends FloatingModule {
  private keysContainer = document.createElement("div");
  private midiApi: MidiController | null = null;
  ...
  private setupMidiApi() {
    this.midiApi = new MidiController(this.store);
  }
