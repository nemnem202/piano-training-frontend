...
import { IrealChartDecoder } from "../../../core/data_parsing/ireal_pro_chart_decoder";
import { IrealDataMapper } from "../../../core/data_parsing/ireal_pro_data_mapper";
import { Spinner } from "../../_base/spinner/spinner";
...
export class ImportModal extends Component {
  ...
  private initializeElements() {
    ...
    this.router = AppRunner.getInstance().router;
  ...
  private async processPlaylistCreation(url: string) {
    const playlistInterpreter = new IrealChartDecoder(url);
    const playlist = IrealDataMapper.convertPlaylist(playlistInterpreter);
